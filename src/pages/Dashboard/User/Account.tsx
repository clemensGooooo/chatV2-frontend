...
export const Account = () => {
    ...
    const handleFileUpload = (file: File | null) => {
        if (file) {
            ...
            axios.post(url_main + "user/profile/image", formData, { headers })
                .then((response) => {
                ...
                <Dialog open={openPasswdChange} onClose={handleClose}>
                    ...
                    <DialogContent>
                        ...
                        <TextField
                            ...
                            variant="standard"
                            error={passwordErr}
                            helperText={passwordErr ? "Something went wrong /check your old pwd !" : undefined}
